...
class AddSellerListingScreen extends StatelessWidget {
  const AddSellerListingScreen({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Center(
                  child: MyElevatedButton(
                      width: Get.width - 120,
                      onPressed: () {
                        Get.toNamed(AppRouter.getMyListingRoute());
                      },
